...
struct LocalFAQData {
    static let items: [FAQItem] = [
        ...
        FAQItem(
            ...
            answerPt: "Voce tem 7 dias para experimentar todos os recursos Premium gratuitamente. Durante esse periodo, voce pode cancelar a qualquer momento sem ser cobrado.",
            answerEn: "You have 7 days to try all Premium features for free. During this period, you can cancel at any time without being charged.",
            answerEs: "Tienes 7 dias para probar todas las funciones Premium gratuitamente. Durante este periodo, puedes cancelar en cualquier momento sin que te cobren.",
            orderIndex: 1,
            isActive: true,
            createdAt: Date(),
            updatedAt: Date()
